...
/**
 * Superclass for router tests. Sets up the environment by creating multiple hosts with router set
 * by {@link #setRouterProto(MessageRouter)}
 */
public abstract class AbstractRouterTest extends TestCase {
  ...
  protected void checkDelivered(DTNHost from, DTNHost to, String msgId, boolean isFirstDelivery) {
    if (isFirstDelivery) {
